...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    # folder_path = '../DIV2K_LSDIR/DIV2K_LSDIR_train_HR_sub'
    # lmdb_path = '../DIV2K_LSDIR/DIV2K_LSDIR_train_HR_sub.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    # folder_path = '../Flickr2K_LR_bicubic/DF2K_train_LR_bicubic_X2_sub'
    # lmdb_path = '../Flickr2K_LR_bicubic/DF2K_train_LR_X2_sub.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx3 images
    folder_path = '../Flickr2K_LR_bicubic/DF2K_train_LR_bicubic_X3_sub'
    lmdb_path = '../Flickr2K_LR_bicubic/DF2K_train_LR_X3_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # # LRx4 images
    # folder_path = '../DIV2K_LSDIR/DIV2K_LSDIR_train_LR_X4_sub'
    # lmdb_path = '../DIV2K_LSDIR/DIV2K_LSDIR_train_LR_X4_sub.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
